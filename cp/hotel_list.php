...
<span style="font-size:16px; font-weight:bold">Hotel List</span><span style="font-size:13px; color:#F00; padding-left:200px;"><?php if(isset($_SESSION['msg_exists'])){ echo $_SESSION['msg_exists']; }
unset($_SESSION['msg_exists']);?></span>
    <input type="button" value="Add New Hotel" onClick="window.location.href='add_edit_hotel.php?rid=0&cid=0'" style="background: #EFEFEF; float:right"/>
 <hr />
